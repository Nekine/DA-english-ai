...
const Login: React.FC = () => {
    ...
    const startGoogleLogin = () => {
        ...
        const redirectUrl = `${backendBaseUrl}/auth/google?redirect=${encodeURIComponent(frontendCallbackUrl)}`;
            ...
            >
                <div className="flex flex-col items-center mb-8">
                    <Link to="/" className="flex items-center gap-2 mb-6">
                        <span className="text-3xl font-bold bg-gradient-to-r from-primary via-dictionary to-exercises bg-clip-text text-transparent">DALTK</span>
                    </Link>
                ...
                >
                    ...
                    <div className="flex justify-center">
                        ...
                        <Button
                            type="button"
                            variant="outline"
                            className="w-full py-4 text-sm font-medium bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-200"
                            disabled={isLoading}
                            onClick={() => {
                                try {
                                    setIsLoading(true);
